...
# Example usage
target_positions = [[2.0, -0.7], [-0.1, -0.9], [-2.0, -1.0], [-1.0, 0.7], [2.0, 1.0], [-0.5, -0.5], [1.6, 1.1]]
drones = [[0, 0], [3, 3]]

# Scenario 1: Assign the additional point to the 1st drone (index 0)
output_scenario_1 = assign_targets_with_path_lengths(drones, target_positions, assigned_drone_index=0)

# Scenario 2: Assign the additional point to the 2nd drone (index 1)
output_scenario_2 = assign_targets_with_path_lengths(drones, target_positions, assigned_drone_index=1)

print("Scenario 1 output:", output_scenario_1)  # [total distance, distance for drone 1, distance for drone 2]
print("Scenario 2 output:", output_scenario_2)
